...
export function ShareSetlistDialog({ isOpen, onOpenChange, setlist, onStatusChange }: ShareSetlistDialogProps) {
  ...
  const handlePublicToggle = async (checked: boolean) => {
    ...
    try {
        ...
        toast({
            ...
            description: checked ? "Other users can now find and use this setlist." : "This setlist is no longer publicly searchable.",
        })
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Use the link to share this setlist, or make it public for others to discover.
          </DialogDescription>
        </DialogHeader>
