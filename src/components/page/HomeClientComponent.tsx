  ...
  return (
    <>
      <div className='flex-grow flex flex-col'>
        <Header />
        <main className='flex-grow container mx-auto px-4 py-4 space-y-12 pb-24 md:pb-12'>
          ...
          <form onSubmit={handleSearchSubmit}>
            <input
              ...
              className='w-full p-3 pl-10 text-base border rounded-lg bg-background focus:outline-none active:outline-none'
              style={{
