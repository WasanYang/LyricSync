        ...
        <div className="flex-grow flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 pb-24 md:pb-8">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-bold font-headline mb-4">Go Premium</h1>
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-12">
                        Unlock powerful features to elevate your performance and practice sessions.
                    </p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
                    <div className="md:col-span-2 p-8 bg-muted/50 rounded-lg">
                        <h2 className="text-xl font-bold font-headline mb-6">What's Included:</h2>
                    ...
                    <div className="md:col-span-3 space-y-6">
                        <Card 
                            className={cn("cursor-pointer transition-all", selectedPlan === 'monthly' && "border-primary ring-2 ring-primary")}
                        ...
                        >
                         ...
                         <Card 
                            className={cn("cursor-pointer transition-all relative overflow-hidden", selectedPlan === 'yearly' && "border-primary ring-2 ring-primary")}
