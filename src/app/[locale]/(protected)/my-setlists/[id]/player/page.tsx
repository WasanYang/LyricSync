          ...
          <div className='flex items-center justify-between w-full'>
            <div className='flex items-center gap-2 min-w-0'>
              ...
              <div className='min-w-0'>
                <h1 className='font-headline text-base sm:text-lg font-bold truncate leading-tight'>
                  {setlist.title}
                </h1>
                <p className='text-xs sm:text-sm text-muted-foreground'>{`Song ${
                  currentIndex + 1
                } of ${songs.length}`}</p>
              </div>
            </div>
                ...
                <div className='flex items-center justify-end gap-2'>
                  ...
                  {nextSong && (
                    <div className='flex-shrink-0 text-center'>
                      <p className='font-bold leading-tight text-xs sm:text-sm'>
                        ({getTransposedKey(transpose)})
                      </p>
                    </div>
                  )}
                </div>
