...
import { Play, Check, Share2, Library } from 'lucide-react';
...
import { useGetSetlistByIdQuery } from '@/store/setlistApi';
...
export function SetlistDetailContent({
  onLoadingChange,
  id,
}: {
  ...
  const { data, isLoading } = useGetSetlistByIdQuery(id);
  useEffect(() => {
