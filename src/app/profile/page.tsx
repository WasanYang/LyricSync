                ...
                <div className="space-y-8 max-w-2xl mx-auto">
                    ...
                    {isAnonymous ? (
                        <Card className="bg-primary/10 border-primary/20">
                            <CardHeader>
                                <CardTitle className="font-headline text-center">Unlock Full Access</CardTitle>
                                <CardDescription className="text-center">
                                    Sign in with Google to save your songs, create setlists, and sync your data across devices.
                                </CardDescription>
                            </CardHeader>
