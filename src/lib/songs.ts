...
const songs: Song[] = [
  ...
  },
  {
    ...
    lyrics: [
      ...
      { time: 10, text: "" },
      { time: 11, text: "[A]A thousand generations" },
      ...
      { time: 36, text: "" },
      { time: 37, text: "Your name is the [A]highest" },
      ...
      { time: 85, text: "" },
      { time: 86, text: "[A]If you’ve been forgiven" },
      ...
      { time: 111, text: "" },
      { time: 112, text: "And the angels [D]cry, [A]Holy" },
      ...
      { time: 160, text: "" },
      { time: 161, text: "And the angels [D]cry, [A]Holy" },
